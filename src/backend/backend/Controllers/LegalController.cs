...
namespace Backend.Controllers
{
    ...
    public class LegalController : ControllerBase
    {
        ...
        private const string LastUpdated = "September 15, 2026";
        ...
        private static readonly (string Heading, string Body)[] TermsSections =
        {
            ...
            ("Termination",
                "You can delete your account at any time from Profile → Settings → Delete Account, or by emailing support@moviespaces.org. We may suspend or terminate accounts that violate these Terms, abuse other users, misuse the reporting or blocking system, or create legal risk for us or other users. Sections that by their nature should survive termination — content licenses already granted for content you haven't deleted, disclaimers, limitation of liability, indemnification, and governing law — survive."),
            ("Disclaimers",
        ...
        private static readonly (string Heading, string Body)[] PrivacySections =
        {
            ...
            ("Your Rights (EEA, UK, and elsewhere)",
                "Depending on where you live, you may have the right to: access the personal data we hold about you; correct inaccurate data; delete your data; restrict or object to certain processing; receive your data in a portable, machine-readable format; and withdraw consent you previously gave, at any time. Many of these you can exercise directly in the app — edit your profile from the Profile tab, revoke location or notification permissions in your device settings, and delete everything from Profile → Settings → Delete Account. For anything else, email support@moviespaces.org and we'll respond within 30 days. You won't be charged or treated differently for exercising these rights. If you're in the EEA or UK and think we've handled your data improperly, you also have the right to complain to your local data protection authority."),
        ...
        private static readonly (string Heading, string Body)[] SupportSections =
        {
            ...
            ("Deleting Your Account",
                "Profile → Settings → Delete Account removes your profile, your messages, and any Spaces you host. It takes effect immediately and can't be undone. You don't need to contact us to do it."),
            ("Common Questions",
